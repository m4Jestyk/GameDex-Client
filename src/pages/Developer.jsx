...
const Developer = () => {
  ...
  //       `http://localhost:8080/api/v1/games?developer=${developer}`
  //     );
  //     console.log(data);
  //   } catch (error) {
    ...
    <>
      ...
      >
        <Flex mb={-50} wrap="wrap" justifyContent="center" gap={1}>
          <DevCard
            onClick={() => dispatch(setDeveloper("electronic+arts"))}
            navigateTo="result"
            name="E A"
          ...
          />
          <DevCard
            onClick={() => dispatch(setDeveloper("blizzard"))}
            name="B L I Z Z A R D"
          ...
          />
          <DevCard
            onClick={() => dispatch(setDeveloper("rockstar"))}
            name="R O C K S T A R"
        ...
        <Flex wrap="wrap" justifyContent="center" gap={1}>
          <DevCard
            onClick={() => dispatch(setDeveloper("ubisoft"))}
            name="U B I S O F T"
          ...
          />
          <DevCard
            onClick={() => dispatch(setDeveloper("sony"))}
            name="S O N Y"
          ...
          />
          <DevCard
            onClick={() => dispatch(setDeveloper("valve"))}
            name="V A L V E"
        ...
        <Flex>
          <h3>Other? type it in...</h3>
          <input onChange={handleInput} type="text" placeholder="Developer" />
